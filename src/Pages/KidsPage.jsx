  ...
  return (
    ...
    <div className="">
      <div className="row">
        ...
        <CirCatCont name="toys"  image="https://i5.walmartimages.com/dfw/4ff9c6c9-1f0e/k2-_ad16c8b5-42e6-4707-9799-5ea99449ed05.v1.jpg?odnHeight=290&odnWidth=290&odnBg=FFFFFF"/>
        </div>
        </div>
      <div className="row">
      <div className="col-lg-3">
      <DropDownCont image="https://i5.walmartimages.com/dfw/4ff9c6c9-b4be/k2-_9c1576a2-807d-410a-a27c-2900adb5eff3.v1.jpg?odnHeight=48&odnWidth=48&odnBg=FFFFFF" name="Fresh Food"/>
        </div>
